...
export const SalesPlanSearch = () => {
    ...
    const handlerSearch = () => {
        setSearchKeyword({
            ...
            group_code: SalesSearch().searchKeyword.group_code,
            product_code: SalesSearch().searchKeyword.product_code,
            target_date: SalesSearch().searchKeyword.target_date,
            product_name: SalesSearch().searchKeyword.product_name,
    ...
    return (
        <SalesPlanSearchStyled>
            <span>
                {"산업군"}
                <StyledSelectBox
                    options={SalesSearch().searchKeyword.manuFacturerOptions}
            ...
            <span>
                {"대분류"}
                <StyledSelectBox
                    options={SalesSearch().searchKeyword.mainCategoryOptions}
            ...
            <span>
                {"소분류"}
                <StyledSelectBox
                    options={SalesSearch().searchKeyword.subCategoryOptions}
            ...
            <span>
                {"제품"}
                <StyledSelectBox
                    options={SalesSearch().searchKeyword.productOptions}
                    value={selectProduct}
